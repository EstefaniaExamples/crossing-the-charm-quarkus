...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.data.jdbc.JdbcRepositoriesAutoConfiguration");
    ...
    factories.add(org.springframework.boot.test.autoconfigure.data.jdbc.AutoConfigureDataJdbc.class, () -> new org.springframework.boot.autoconfigure.data.jdbc.JdbcRepositoriesAutoConfiguration());
